...
from .views import AccountRegisterView, LoginView, AccountRetrieveUpdateView, SetPasswordConfirmAPIView, \
    SetNewPasswordView, ChangePasswordCompletedView, EmailVerificationAPIView
